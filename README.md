# CyclEase
This project consists of a Flutter mobile application that allows users to control a self balancing bicycle using a reaction wheel built for my final year project aiming to help kids learn how to ride a bicycle.
...
-	A trainer mode which will teach and guide the child to steer into the direction of a fall to balance, also known as counter steering, will help the child understand how to shift his/her body weight while riding. 
